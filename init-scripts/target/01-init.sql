-- Create orders table (matching source structure but without SERIAL)
...
-- Create batch control table (identical to source, but without foreign key constraints)
...
-- Create the same monitoring functions as source
